...
import { NativeStackNavigationProp } from "@react-navigation/native-stack"; // Changed to native-stack
import { Ionicons } from "@expo/vector-icons";
import { InventoryContext } from "@/src/context/InventoryContext";

// Define types
type RootStackParamList = {
  ProductDetail: { productId?: number; barcode?: string };
};
  ...
  useEffect(() => {
    if (productId) {
      ...
      if (existingProduct) {
        ...
        // If product not found in local state, fetch from API
